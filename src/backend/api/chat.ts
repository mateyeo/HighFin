...
- Write in plain text only. Do not use any markdown formatting: no asterisks, no pound signs, no dashes or hyphens as bullet points, no backticks, no bold, no italic. If you need to list items, write them as numbered sentences (1. 2. 3.) or simply separate them with commas or line breaks.
